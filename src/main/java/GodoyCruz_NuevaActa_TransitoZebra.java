...
class GodoyCruz_NuevaActa_TransitoZebra {
    ...
    public void Descarga() throws InterruptedException {
        ...
        tipoActaSelect.selectByVisibleText("TRANSITO");
        Thread.sleep(6000);
        ...
        String newFileName = "Acta_TransitoZebra.pdf"; // Establece el nombre que desees
