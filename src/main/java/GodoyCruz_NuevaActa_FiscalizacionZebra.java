...
class GodoyCruz_NuevaActa_FiscalizacionZebra {
    ...
    public void Descarga() throws InterruptedException {
        ...
        WebElement element = driver.findElement(By.cssSelector("#vIMPRIMIRZEBRA_ACTION_0001"));
        Thread.sleep(6000);
        ...
        String newFileName = "Acta_FiscalizacionZebra.pdf"; // Establece el nombre que desees
