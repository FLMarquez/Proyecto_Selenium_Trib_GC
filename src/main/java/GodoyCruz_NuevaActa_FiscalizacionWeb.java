...
class GodoyCruz_NuevaActa_FiscalizacionWeb {
    private WebDriver driver;
    private String downloadFilePath = "C:\\Users\\Lmarquez\\Desktop\\Escritorio PC Lucas\\GODOY CRUZ\\DescargaPDF\\Nuevacta\\PRODUCCION";
    ...
    By nuevacta = By.xpath("//span[@class='sidebar-nav-item'][contains(.,'Nuevas Actas')]");
    By consultaActa = By.xpath("//a[contains(.,'Consulta de Actas')]");
    ...
    public void beforeClass() {
        ...
        try {
            ...
            //profile.setPreference("layout.css.devPixelsPerPx", "0.8"); // Establece el zoom al 80%
    ...
    public void Descarga() throws InterruptedException {
        ...
        tipoActaSelect.selectByVisibleText("FISCALIZACIÓN");
        //Select tipoActaSelect = new Select(tipoActa);
        //List<WebElement> options = tipoActaSelect.getOptions();
        //for (WebElement option : options) {
            //if (option.getText().contains("FIZC")) {
                //tipoActaSelect.selectByVisibleText(option.getText());
                //break; // Si solo quieres seleccionar el primer elemento que coincida, si no, elimina esta línea
        ...
        String newFileName = "Acta_FiscalizacionWeb.pdf"; // Establece el nombre que desees
